...
fun initDb(host: String, port: Int, database: String, username: String, password: String) {
    ...
    config.leakDetectionThreshold = 45000
...
fun setValue(table: String, player: Player, key: String, value: String) {
    prepareStatement("UPDATE $table SET $key = '${value}' WHERE uuid = '${player.uniqueId}';").executeUpdate()
}
 ...
 * @param table Name of table to get
 */
